...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(x,u){return"function"==typeof x?function(r){try{m(x(r))}catch(t){q(t)}}:u}var m,q,p=new f(function(x,u){m=x;q=u});this.callWhenSettled_(l(h,m),l(k,q));return p};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
q){function p(r){return function(t){x[r]=t;u--;0==u&&m(x)}}var x=[],u=0;do x.push(void 0),u++,d(l.value).callWhenSettled_(p(x.length-1),q),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
value:fullScreenApi.isFullScreen()},b);fullScreenApi.isFullScreen()?MiniStyle.hide():MiniStyle.show();(function(){if(global.toolBar&&global.toolBar.onResize)toolBar.onResize()}).delay(100)}function fullscreenFun(){var b=$("body")[0];fullScreenApi.supportsFullScreen&&(fullScreenApi.isFullScreen()?fullScreenApi.cancelFullScreen():fullScreenApi.requestFullScreen(b));b.webkitSupportsFullscreen&&b.webkitEnterFullscreen(Element.ALLOW_KEYBOARD_INPUT)}
...
n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var w=this.simultaneous;n=aa(n,this);w[n.id]||(w[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=aa(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;var w=this.requireFail;n=aa(n,this);-1===t(w,n)&&(w.push(n),n.requireFailure(this));
return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=aa(n,this);n=t(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function w(C){y.manager.emit(C,n)}var y=this,B=this.state;8>B&&w(y.options.event+ja(B));w(y.options.event);n.additionalEvent&&w(n.additionalEvent);8<=B&&w(y.options.event+ja(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);
...
100;var q=e*h,p=e*k,x=0,u=0,r=0,t=0;toolBar&&(x=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,u=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,r=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,t=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(q>windowWidth){var v=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-t;l=-l-h*e*d.parameters.zoomArea.left/100+r}else v=-l-h*e*d.parameters.zoomArea.left/100+r,l=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-
t;p>windowHeight?(h=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-u,d=-m-k*e*d.parameters.zoomArea.top/100+x):(h=-m-k*e*d.parameters.zoomArea.top/100+x,d=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-u);g=Number.between(g,v,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),q=getHost();if(m&&q!==m){if(g=f.src.replace(m,q),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(t){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var p=h.getImageData(0,0,k,l),x=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&p){var u=Color(b).split();k=0;for(var r=p.data.length;k<r;k+=4)0<x.data[k+3]&&(p.data[k]!=u.r&&(x.data[k]=p.data[k]/255*u.r),p.data[k+1]!=u.g&&(x.data[k+1]=
p.data[k+1]/255*u.g),p.data[k+2]!=u.b&&(x.data[k+2]=p.data[k+2]/255*u.b));h.putImageData(x,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(t){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(v){}})}}}}};
...
(function(b){function c(u,r){var t=(u&65535)+(r&65535);return(u>>16)+(r>>16)+(t>>16)<<16|t&65535}function d(u,r,t,v,z,A){u=c(c(r,u),c(v,A));return c(u<<z|u>>>32-z,t)}function e(u,r,t,v,z,A,F){return d(r&t|~r&v,u,r,z,A,F)}function f(u,r,t,v,z,A,F){return d(r&v|t&~v,u,r,z,A,F)}function g(u,r,t,v,z,A,F){return d(t^(r|~v),u,r,z,A,F)}function h(u,r){u[r>>5]|=128<<r%32;u[(r+64>>>9<<4)+14]=r;var t=1732584193,v=-271733879,z=-1732584194,A=271733878;for(r=0;r<u.length;r+=16){var F=t;var D=v;var L=z;var M=A;
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this;k=d(h);var m=void 0!==k&&null!==k?k:"__default__";e[m]&&clearTimeout(e[m]);return new Promise(function(q,p){f[m]||(f[m]=[]);f[m].push({resolve:q,reject:p});e[m]=setTimeout(function(){var x,u,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){switch(t.nextAddress){case 1:return x=f[m],t.setCatchFinallyBlocks(2,3),t.yield(b.apply(l,
h),5);case 5:u=t.yieldResult,x&&x.forEach(function(v){return v.resolve(u)});case 3:t.enterFinallyBlock();delete e[m];delete f[m];t.leaveFinallyBlock(0);break;case 2:r=t.enterCatchBlock(),x&&x.forEach(function(v){return v.reject(r)}),t.jumpTo(3)}})},c)})}}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d",{willReadFrequently:!0});l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var q=m.getImageData(0,0,l.width,l.height),p=q.data,x=c?e(c):null,u=d?e(d):{r:0,g:0,b:0,a:0},r=0;r<p.length;r+=4){var t=p[r+3];0===t?(p[r]=u.r,p[r+1]=u.g,p[r+2]=u.b,p[r+3]=void 0!==u.a?u.a:0):0<t&&255>t?x&&(p[r]=Math.round((x.r*t+u.r*(255-t))/255),p[r+1]=Math.round((x.g*t+u.g*(255-t))/255),p[r+2]=Math.round((x.b*t+u.b*(255-t))/255),
...
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(p,x){var u=c();try{var r=x&&"object"===typeof x?Object.assign({},x):x;if(r&&"object"===typeof r){r.page=Number(p+1);var t=u[p];t&&t.positions&&r.positions?r.positions=t.positions.concat(r.positions):t&&t.positions&&(r.positions=t.positions);null!=l?r.realPage=Number(l):t&&t.realPage&&(r.realPage=t.realPage);t&&Object.keys(t).forEach(function(v){"page"===v||"realPage"===v||"positions"===
v||v in r||(r[v]=t[v])})}u[p]=r;return!0}catch(v){return console.error("writeToTarget error",v),!1}}function e(p,x,u){if(!p||0===p.length)return null;for(var r=p[0].left,t=p[0].top,v=p[0].right,z=p[0].bottom,A="",F=0;F<p.length;F++){var D=p[F];r=Math.min(r,D.left);t=Math.min(t,D.top);v=Math.max(v,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=r/x;t/=u;v/=x;u=z/u;u=[F,u,v,u,v,t,F,t];z=[];for(F=0;F<p.length;F++)z.push(p[F].width/x);if(!A||0===A.trim().length)return null;p=u.concat(z);return{w:A,p:p}}
function f(p){b._pageReaderExtracted||(b._pageReaderExtracted={});p=Array.isArray(p)?p:[p];for(var x=0,u=0;u<p.length;u++){var r=p[u];if(r&&!(1>r)&&!b._pageReaderExtracted[r])if(b._pageReaderExtracted[r]=!0,window._getPage&&"function"===typeof window._getPage)try{var t=window._getPage(r-1);if(t){var v=null;if(t.items&&Array.isArray(t.items)){v=t.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<v.length;D++){var L=v[D];if(L&&"text"===L.type&&
...
la)}else console.warn("PageTextExtractor: window._getPage \u65b9\u6cd5\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u63d0\u53d6\u6587\u672c\u914d\u7f6e")}return x}function g(p){var x,u,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(!p||1>p)return t.return(!1);b._positionScriptLoaded||(b._positionScriptLoaded={});b._positionScriptLoadPromises||(b._positionScriptLoadPromises={});x=b.getSearchRealPageIndex(p);if(0>=x||-1===x||b._positionScriptLoaded[x])return t.return(!1);if(u=b._positionScriptLoadPromises[x])return t.return(u);
...
case 3:D.enterFinallyBlock();delete b._positionScriptLoadPromises[x];D.leaveFinallyBlock(0);break;case 2:return F=D.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),D.return(!1)}})}();b._positionScriptLoadPromises[x]=r;return t.return(r)})}function h(p,x,u){var r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){r=function(){var v,z,A,F,D,L,M,I;return $jscomp.asyncExecutePromiseGeneratorProgram(function(G){switch(G.nextAddress){case 1:k=p;l=u;if(v=
...
(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(p){var x,u,r,t,v,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),x=Array.isArray(p)?p:[p],u=[],r=!1,t=0;case 2:if(!(t<x.length)){D.jumpTo(4);break}v=x[t];if(!v||1>v){D.jumpTo(3);break}z={pageIndex:v,hasText:!1,
positionCount:0};D.setCatchFinallyBlocks(5);return D.yield(g(v),7);case 7:b._pageReaderExtracted[v]||f(v);(A=c()[v-1])&&A.page===v&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,r=!0);D.leaveTryBlock(6);break;case 5:F=D.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+v+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:u.push(z);case 3:t++;D.jumpTo(2);break;case 4:return D.return({hasText:r,pageResults:u})}})};
b.hasPageText=function(p){b.pageTextPositions||(b.pageTextPositions=[]);var x=!Array.isArray(p),u=[],r=!1;p=$jscomp.makeIterator(x?[p]:p);for(var t=p.next();!t.done;t=p.next())if(t=t.value,!t||1>t)x||u.push({pageIndex:t,hasText:!1,positionCount:0});else{var v={pageIndex:t,hasText:!1,positionCount:0},z=t-1;(z=c()[z])&&z.page===t&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(v.hasText=!0,v.positionCount=z.positions.length,r=!0);if(x)return v.hasText;u.push(v)}return{hasText:r,pageResults:u}};
...
("undefined"!==typeof c?c:"")).trim(),"string"==typeof r&&(r=r.replaceAll("\\/","/",!0),r=r.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(r)))return""},m,q,p,x,u;if((null==(m=window.tmpBookConfig)?0:null==(q=m.power_info)?0:q.power)||(null==(p=window.bookConfig)?0:null==(x=p.power_info)?0:x.power)||(null==(u=window.userInfo)?0:u.power)||!window.eventEmitter||"function"!==typeof window.eventEmitter.on)return l(k());window.eventEmitter.on("loadUserInfo",function(r){return l(k())})}
...
tmpBookConfig.isFirstLastShortcutVisible=getConfigValue("isFirstLastShortcutVisible",void 0);void 0!==tmpBookConfig.isFirstLastShortcutVisible&&(tmpBookConfig.isFirstLastShortcutVisible=parseBool(tmpBookConfig.isFirstLastShortcutVisible));tmpBookConfig.miniFullscreenDisplayType=getConfigValue("miniFullscreenDisplayType","always").toLowerCase();tmpBookConfig.isFakeStopBook=getConfigValue("isFakeStopBook",0);tmpBookConfig.isTabelOfContentSearchBarVisible=getConfigValue("isTabelOfContentSearchBarVisible",
!0);tmpBookConfig.mouseDragFlip=getConfigValue("mouseDragFlip",!0);tmpBookConfig.disablePrintShortcut=getConfigValue("disablePrintShortcut",!1);tmpBookConfig.chatBotButtonIconHeight=getConfigValue("chatBotButtonIconHeight",48);tmpBookConfig.chatBotButtonIcon=getConfigValue("chatBotButtonIcon","");tmpBookConfig.isAccessibilityButtonVisible=getConfigValue("isAccessibilityButtonVisible",!1);tmpBookConfig.ClientBookId=getConfigValue("ClientBookId","");tmpBookConfig.CreatedTime=getConfigValue("CreatedTime",
"");window.editConfig&&window.editConfig.CreatedTime&&(tmpBookConfig.CreatedTime=window.editConfig.CreatedTime);tmpBookConfig.CreatedVersion=getConfigValue("CreatedVersion","");tmpBookConfig.productName=getConfigValue("productName","");tmpBookConfig.productVersion=getConfigValue("productVersion","");tmpBookConfig.PDFBASE_VERSION_MAC=getConfigValue("PDFBASE_VERSION_MAC","");tmpBookConfig.PDFBASE_VERSION=getConfigValue("PDFBASE_VERSION","");tmpBookConfig.isCachePages=getConfigValue("isCachePages",!1);
tmpBookConfig.displayNumberOfShares=getConfigValue("displayNumberOfShares",!1);tmpBookConfig.additionalNumberOfShare=getConfigValue("additionalNumberOfShare",0);tmpBookConfig.flipSoundURL=getConfigValue("flipSoundURL","");tmpBookConfig.isTableOfContentPagesVisible=getConfigValue("isTableOfContentPagesVisible",!1);tmpBookConfig.isArticlePhoneMoreButtonVisible=getConfigValue("isArticlePhoneMoreButtonVisible",!1);tmpBookConfig.alwaysShowBottomFullscreenPrompt=getConfigValue("alwaysShowBottomFullscreenPrompt",
...
void 0);tmpBookConfig.socialShareType=getConfigValue("socialShareType","0");tmpBookConfig.isRestorePageFrameVisible=getConfigValue("isRestorePageFrameVisible",!0);tmpBookConfig.alwaysShowBookInstructionOnStart=getConfigValue("alwaysShowBookInstructionOnStart","0");tmpBookConfig.showBookInstructionCountOnStart=getConfigValue("showBookInstructionCountOnStart",3);tmpBookConfig.toolBarBrandInfoVisible=getConfigValue("toolBarBrandInfoVisible",void 0);void 0!==tmpBookConfig.toolBarBrandInfoVisible&&(tmpBookConfig.toolBarBrandInfoVisible=
parseBool(tmpBookConfig.toolBarBrandInfoVisible));tmpBookConfig.toolBarBrandInfoUrl=getConfigValue("toolBarBrandInfoUrl","");tmpBookConfig.loadingBrandInfoVisible=getConfigValue("loadingBrandInfoVisible",!1);tmpBookConfig.loadingBrandInfoUrl=getConfigValue("loadingBrandInfoUrl","");tmpBookConfig.relatedBrandInfoVisible=getConfigValue("relatedBrandInfoVisible",!1);tmpBookConfig.relatedBrandInfoUrl=getConfigValue("relatedBrandInfoUrl","");tmpBookConfig.relatedCardVisible=getConfigValue("relatedCardVisible",
!1);tmpBookConfig.relatedCardUrl=getConfigValue("relatedCardUrl","");tmpBookConfig.bookBaseURL=getConfigValue("bookBaseURL","");tmpBookConfig.bookResourceBaseURL=getConfigValue("bookResourceBaseURL","");!tmpBookConfig.bookResourceBaseURL&&window.htmlConfig&&window.htmlConfig.loadingConfig&&window.htmlConfig.loadingConfig.bookResourceBaseURL&&(tmpBookConfig.bookResourceBaseURL=window.htmlConfig.loadingConfig.bookResourceBaseURL);!tmpBookConfig.bookResourceBaseURL&&window.bookResourceBaseURL&&(tmpBookConfig.bookResourceBaseURL=
window.bookResourceBaseURL);try{tmpBookConfig.bookResourceBaseURL||"Chinese"==UserGroups||"article"!=window.templeteName&&"article2"!=window.templeteName&&"article3"!=window.templeteName||(tmpBookConfig.bookResourceBaseURL=window.location.origin+window.location.pathname.remove("mobile/index.html"),tmpBookConfig.bookResourceBaseURL=tmpBookConfig.bookResourceBaseURL.remove("index.html"))}catch(m){}tmpBookConfig.enableCustomizedBookmarkWidth=getConfigValue("enableCustomizedBookmarkWidth",!1);tmpBookConfig.customizedBookmarkWidth=
getConfigValue("customizedBookmarkWidth",50);tmpBookConfig.onlyOpenInDingDing=getConfigValue("onlyOpenInDingDing",!1);tmpBookConfig.disableDingDingSharing=getConfigValue("disableDingDingSharing",!1);tmpBookConfig.formBackgroundOpacity=getConfigValue("formBackgroundOpacity",1);tmpBookConfig.phoneToolbarFontSize=getConfigValue("phoneToolbarFontSize","small").toLowerCase();tmpBookConfig.EnableRecognizeQRcodePressOnMobile=getConfigValue("EnableRecognizeQRcodePressOnMobile",!1);tmpBookConfig.mobileThumbnailSearchBarVisible=
getConfigValue("mobileThumbnailSearchBarVisible",!0);tmpBookConfig.loadingMainColor=getConfigValue("loadingMainColor","#1F2232");tmpBookConfig.loadingBackgroundColorType=getConfigValue("loadingBackgroundColorType","1");tmpBookConfig.isShowFirstOrLastPagePrompt=getConfigValue("isShowFirstOrLastPagePrompt",!0);tmpBookConfig.isShowMobileBottomFullscreenPrompts=getConfigValue("isShowMobileBottomFullscreenPrompts",!1);tmpBookConfig.SmallProgramUrl=getConfigValue("SmallProgramUrl","");tmpBookConfig.searchColor=
getConfigValue("searchColor","#00ffff");tmpBookConfig.searchAlpha=getConfigValue("searchAlpha",.3);tmpBookConfig.appLogoIcon=getConfigValue("appLogoIcon","");tmpBookConfig.HomeURL=getConfigValue("HomeURL","");tmpBookConfig.bookTitle=getConfigValue("bookTitle","FLIPBOOK");tmpBookConfig.bookDescription=getConfigValue("bookDescription","");tmpBookConfig.toolbarColor=getConfigValue("toolbarColor","#27181A");tmpBookConfig.iconColor=getConfigValue("iconColor","#FFFFFF");tmpBookConfig.toolbarColor==tmpBookConfig.iconColor&&
(tmpBookConfig.iconColor=Color(tmpBookConfig.toolbarColor).reverse());tmpBookConfig.pageNumColor=getConfigValue("pageNumColor","#000000");tmpBookConfig.formBackgroundColor=getConfigValue("formBackgroundColor",tmpBookConfig.toolbarColor);tmpBookConfig.formFontColor=getConfigValue("formFontColor",tmpBookConfig.iconColor);tmpBookConfig.formBackgroundColor.toLocaleLowerCase()==tmpBookConfig.formFontColor.toLocaleLowerCase()&&(tmpBookConfig.formFontColor=Color(tmpBookConfig.formBackgroundColor).reverse());
...
g,h=null!=(g=b.bookmarkHeight)?g:70,k,l,m,q=!(null==(k=global.bmtConfig)?0:k.onSideEdge)&&0<((null==(l=global.bmtConfig)?void 0:null==(m=l.tabs)?void 0:m.length)||0),p,x=!(null==(p=global.bmtConfig)?0:p.onSideEdge)&&c();(q||x)&&f<h&&(f=h);if(d&&2==global.staticAd.adPosition)if(f<e+20)f+=e+20;else{var u=BookInfo.top()-templateArea.getTopHeight();f=Math.max(f,u)}tmpBookConfig.topMargin=f;var r=tmpBookConfig.ORIGIN_BOTTOM_MARGIN;d&&1==global.staticAd.adPosition&&r<e+20&&(r+=e+20);tmpBookConfig.bottomMargin=
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026052101",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
A.rect.endY&&(z.rect.endY=A.rect.endY);z.rect.width=z.rect.endX-z.rect.x;z.rect.height=z.rect.endY-z.rect.y}});return z}function q(t){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,t,p):p(t)}function p(t){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,t,x):x(t)}function x(t){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var v=bookConfig.periodsConfigPath;v=v.replace("%periodicalId%",window.book_visit.periodicalId);c(v,t,u)}else u(t)}
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),q=b.getContext("2d",{willReadFrequently:!0}),p=q.getImageData(0,0,f,g),x=q.createImageData(c,d);p=p.data;for(var u=x.data,r=0;r<d;r++)for(var t=0;t<c;t++){for(var v=4*(t+r*c),z,A=0,F=0,D=0,L=0,M=0,I=0,G=(r+.5)*k,O=Math.ceil((r+1)*k),K=Math.floor(r*k);K<O;K++){var J=Math.abs(G-(K+.5))/m,Q=(t+.5)*h;J*=J;for(var U=Math.ceil((t+1)*h),T=Math.floor(t*h);T<U;T++)if(z=
...
25,"Sine");q++}.interval(this,l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,x){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,t=$.easing["easeInOut"+x],v=$.easing["easeOut"+x];x=v(null,q,g,b.toPoint.x-g,p);v=v(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(x=t(null,q,g,b.toPoint.x-g,p),v=bookConfig.FlipDirection?f*Math.sqrt(r*r-x*x):r-f*Math.sqrt(u*u-x*x));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:v}):(this.flipToPoint(b,c,d,b.fromPoint,
...
!rightToLeft):this.afterFlipToMin(c,rightToLeft),this.setAttachmentAfterFlipTo(c),this.showPagesAfterFlip&&this.showPagesAfterFlip())},checkFlipping:function(){this.flipping=!1;this.flipPageManager.checkFlipping()?this.flipping=!0:(this.refreshBookMiniFullscreenForCoverSpread(),this.startAnimation(),this.flipToDirection="",this.loading())},refreshBookMiniFullscreenForCoverSpread:function(){this.bookAttachments&&this.bookAttachments.Items&&(0<=BookInfo.getPagesByIndex(this.currentPageIndex).indexOf(1)?
...
global.sharePanel.elements.fillArea(!0,"link"),window.refreshWeixinShareWithCurrentBookMeta&&window.refreshWeixinShareWithCurrentBookMeta());global.downLoadBody&&downLoadBody.gotoPage(b);if(bookConfig.AnnotationButtonVisible&&!isPhone()&&!isPad()&&BookInfo.getBook().bookAttachments.noteAdd)BookInfo.getBook().bookAttachments.noteAdd.onResize();setCurrentIndexTextField(BookInfo.getCurrentPageIndex(),BookInfo.isDoublePage());"popstate"!==d&&setLocationHash(BookInfo.getCurrentPageIndex());global.phoneGotoPagePanel&&
global.phoneGotoPagePanel.visible&&global.phoneGotoPagePanel.refreshSlider();global.NeatStyle&&NeatStyle.refreshSlider();global.assistant&&global.assistant.refresh();global.pcArticlePages&&(global.pcArticlePages.clearHighLight(),global.pcArticlePages.setHighLight(b));global.phoneArticlePages&&(global.phoneArticlePages.clearHighLight(),global.phoneArticlePages.setHighLight(b));global.flipPageAudio&&global.flipPageAudio.playByIndex(b);global.phoneGotoPagePanel&&global.phoneGotoPagePanel.showFirstOrLast();
global.flipShotButton&&global.flipShotButton.showFirstOrLast();global.toolbar&&global.toolBar&&global.toolBar.showFirstOrLast&&global.toolBar.showFirstOrLast();bookConfig.delayToFlipFirst&&1!==b&&(delayToFlipFirstTimer&&clearTimeout(delayToFlipFirstTimer),delayToFlipFirstTimer=setTimeout(function(){firstPageFun("auto flip")},1E3*bookConfig.timeToFlipFirst));global.modernPageBookmarkIndicator&&global.modernPageBookmarkIndicator.refresh()}},gotoPageVisit=function(b,c){var d=window.lastVisitTime?(new Date).getTime()-
window.lastVisitTime:0;window.lastVisitTime=(new Date).getTime();if(!(0>=b||b>bookConfig.totalPageCount)){var e={"phone thumbnail":"thumbnail",thumbnail:"thumbnail","table of content":"toc"};if(e[c]){var f={};BookEvent.trigger("customEvent",["click_"+e[c]+"_page_"+b,(f["click_"+e[c]+"_to_page"]=b,f)])}BookEvent.trigger("flipPage",[c,BookInfo.getCurrentPages().join("-"),BookInfo.getCurrentPagesByIndex(b).join("-"),d])}},BookInfo=Class({statics:{getCurrentPages:function(){var b=[];if(this.isDoublePage()){var c=
...
Math.floor(b/2)+1},getLeftPageIndex:function(b){b=this.getPagesByIndex(b);return 1==b.length&&(1==b[0]&&!bookConfig.RightToLeft||b[0]==totalPageCount&&bookConfig.RightToLeft)?null:b[0]},getRightPageIndex:function(b){b=this.getPagesByIndex(b);return 1==b.length?1==b[0]&&bookConfig.RightToLeft||b[0]==totalPageCount&&!bookConfig.RightToLeft?null:b[0]:b[1]},getLeftPages:function(b){void 0==b&&(b=this.getCurrentPageIndex());b=this.getMinPageIndex(b);return bookConfig.RightToLeft?[b+1,b+2,b+3]:[b,b-1,b-
2]},getRightPages:function(b){void 0==b&&(b=this.getCurrentPageIndex());b=this.getMinPageIndex(b);return bookConfig.RightToLeft?[b,b-1,b-2]:[b+1,b+2,b+3]},getAttachmentByName:function(b){var c=this.getBook();if(!c)return null;var d;return(b=null==c?void 0:null==(d=c.bookAttachments)?void 0:d.getItemByName(b))?b:null},getPageAnnotationByIndex:function(b){var c=this.getBook();if(!c)return null;var d,e,f,g,h=null==(e=null==c?void 0:null==(d=c.pageArray[b])?void 0:d.page)?void 0:null==(f=e.pageAttachments)?
void 0:null==(g=f.pageAnnotation)?void 0:g.pageAnnotation;if(!h){var k,l,m,q,p;h=null==c?void 0:null==(k=c.pageArray[b])?void 0:null==(l=k.pageArray)?void 0:null==(m=l[b])?void 0:null==(q=m.pageAttachments)?void 0:null==(p=q.pageAnnotation)?void 0:p.pageAnnotation}return h}}}),FlipHistory=Class({create:function(){this.array=[];this.currentIndex=0},backward:function(){var b=this.currentIndex-1;void 0!=this.array[b]&&(this.currentIndex=b,gotoPageFun(this.array[b].index,!0,"history"),window.toolBar&&
toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons(),global.phoneGotoPagePanel&&global.phoneGotoPagePanel.updateHistoryButtons&&global.phoneGotoPagePanel.updateHistoryButtons())},forward:function(){var b=this.currentIndex+1;void 0!=this.array[b]&&(this.currentIndex=b,gotoPageFun(this.array[b].index,!0,"history"),window.toolBar&&toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons(),global.phoneGotoPagePanel&&global.phoneGotoPagePanel.updateHistoryButtons&&global.phoneGotoPagePanel.updateHistoryButtons())},
addFromCurrentIndex:function(b){this.array=this.array.slice(0,this.currentIndex+1);this.array.push({index:b});this.currentIndex=this.array.length-1;window.toolBar&&toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons();global.phoneGotoPagePanel&&global.phoneGotoPagePanel.updateHistoryButtons&&global.phoneGotoPagePanel.updateHistoryButtons()},push:function(b){this.array.push({index:b})},canBackward:function(){return void 0!=this.array[this.currentIndex-1]},canForward:function(){return void 0!=
this.array[this.currentIndex+1]}}),flipHistory=new FlipHistory,IssuuPage=Class({create:function(b,c,d,e){this._super(b,c,d,e);this.renderPage();this.addFlipShadow()},remove:function(){this.sideImage&&this.sideImage.remove();this.side.remove();this.sideImage=this.side=void 0;this.pageBackground&&this.pageBackground.destroy();this.render&&(this.render.taskPool.stop(),this.renderInterval&&(window.clearInterval(this.renderInterval),this.renderInterval=void 0));this.hasReader&&this.destroySlider()},destroy:function(){this.pageBackground&&
this.pageBackground.destroy();this.sideImage=this.side=void 0;this.hasReader&&this.destroySlider()},hasReader:function(){return window.readerConfig&&0<window.readerConfig.pages.length&&window.readerConfig.pages.length>=this.pageIndex&&(this.hasReaderItems()||window.inverseEditor&&window.inverseEditor.length&&window.inverseEditor[this.pageIndex-1]&&window.inverseEditor[this.pageIndex-1].length)?!0:!1},hasReaderItems:function(){var b=window.readerConfig.pages[this.pageIndex-1];return b&&0!==Object.values(b).filter(function(c){return Array.isArray(c)&&
c.length}).length},loading:function(){if("restrict"!=BookRestrict.isRestrictPage(this.pageIndex)){if(this.originalImageLoaded)if(this.hasReader()){if(this.pageReaderLoaded)return}else return;this.removeLoad||(this.loadingImage||(this.loadingImage=$("<div class='loadingOuter'><img alt='loadingOuter' width='auto' height='auto' class='loadingImage' src='"+bookConfig.pageLoadingUrl+"'/></div>")),this.sideContent.append(this.loadingImage))}},unLoading:function(b){this.hasReader()&&!b||!this.loadingImage||
(this.loadingImage.css({display:"none"}),this.loadingImage.remove(),this.loadingImage=null)},restrict:function(){if(!this.restrictImage){this.restrictImage=$("<div class='loadingOuter'></div>");var b=1==this.pageIndex?getMeta("og:image"):bookConfig.pageRestrictUrl;this.restrictImage.css({"background-image":"url("+b+")"});1==this.pageIndex?this.restrictImage.css({"background-size":"contain"}):this.restrictImage.css({"background-size":"auto"});this.mirrorRestrict();this.sideContent.append(this.restrictImage)}},
unRestrict:function(){this.restrictImage&&(this.restrictImage.remove(),this.restrictImage=null)},mirrorRestrict:function(){if(this.isMirrorSide&&this.restrictImage){var b="scaleX(-1)";bookConfig.FlipDirection&&(b="scaleY(-1)");this.restrictImage.css({"-webkit-transform":b,"-moz-transform":b,"-o-transform":b,"-ms-transform":b,opacity:.2})}},mirrorSide:function(){this.isMirrorSide=!0;var b="scaleX(-1)";bookConfig.FlipDirection&&(b="scaleY(-1)");this.sideImage.css({"-webkit-transform":b,"-moz-transform":b,
"-o-transform":b,"-ms-transform":b,opacity:.2});this.rendering&&(this.rendering.destroy(),this.rendering=null);this.unLoading()},fillPreviewImage:function(){var b=this,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){if(1==e.nextAddress)return bookConfig.loadPreviewImage?b.isMirrorSide||window.sliderJS&&window.sliderJS[b.pageIndex-1]&&sliderJS[b.pageIndex-1].elements&&sliderJS[b.pageIndex-1].elements.length?e.jumpTo(0):e.yield(getPageDir(b.pageIndex,"previewPage",originTotalPageCount),
...
l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,x){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,t=$.easing["easeInOut"+x],v=$.easing["easeOut"+x];x=v(null,q,g,b.toPoint.x-g,p);v=v(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(x=t(null,q,g,b.toPoint.x-g,p),v=bookConfig.FlipDirection?f*Math.sqrt(r*r-x*x):r-f*Math.sqrt(u*u-x*x));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:v}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
d=void 0,x=transformCSS({scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})):(d=void 0,x=transformCSS({origin:g,scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})));p.setCSSByStyle(x);if(p.page.pageFlipShadow){var u=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});p.page.pageFlipShadow&&p.page.pageFlipShadow.setCSSByStyle(u)}}}return{x:m,y:q}}catch(r){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,
...
(function(b){function c(h,k){h=h.querySelectorAll("canvas");var l=k.querySelectorAll("canvas"),m=[];h.forEach(function(q,p){var x=l[p];if(x){x.width=q.width;x.height=q.height;q=q.toDataURL();var u=new Image;p=new Promise(function(r){u.onload=function(){x.getContext("2d").drawImage(u,0,0);r()};u.onerror=function(){return r()}});u.src=q;m.push(p)}});return Promise.all(m).then(function(){})}var d=0,e={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},f={};b.fn.printArea=function(h){b.extend(f,e,h);d++;b("[id^=printArea_]").remove();f.id="printArea_"+d;var k=b(this),l=g.getPrintWindow();g.write(l.doc,k);c(b(this)[0],l.doc).then(function(){function m(){p&&p();g.print(l)}var q=b(l.doc).find("img"),p=h&&"function"===typeof h.onReady?h.onReady:null;if(0===q.length)m();else{var x=0;q.each(function(u,r){if(r.complete)x++,x===q.length&&m();else b(r).on("load error",function(){x++;x===q.length&&
