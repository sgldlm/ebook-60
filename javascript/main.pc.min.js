...
(function(a){function b(d){function e(){n.classList.remove("show");clearTimeout(k);setTimeout(function(){n.remove();l&&l()},250)}var f=d.message,g=d.type,h=d.duration,l=d.onClose;d=d.showClose;var n=document.createElement("div");n.className="flip-message "+(g||"info");g=document.createElement("span");g.className="flip-message-content";g.textContent=null==f?"":String(f);n.appendChild(g);d&&(f=document.createElement("span"),f.className="flip-message-close",f.textContent="\u00d7",f.addEventListener("click",
function(){return e()}),n.appendChild(f));g.style.color=bookConfig.searchHightlightColor;setTimeout(function(){return n.classList.add("show")});var k=null;0!==h&&(k=setTimeout(function(){return e()},h||3E3));return n}function c(d){"string"===typeof d&&(d={message:d});var e=document.getElementById("flip-message-container");e||(e=document.createElement("div"),e.id="flip-message-container",e.className="flip-message-container",document.body.appendChild(e));d=b(d);e.appendChild(d);return d}["success",
"info","warning","error"].forEach(function(d){c[d]=function(e,f){f=void 0===f?{}:f;return c(Object.assign({},{message:e,type:d},f))}});a.MessageBox=c})(window);
