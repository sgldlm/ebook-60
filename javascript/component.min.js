...
global.FB?(FB.init({appId:b(),status:!0,xfbml:!1,version:"v2.4"}),c()):window.open("http://www.facebook.com/sharer.php?u="+share_url.toString())})()},getEmailUrl=function(){if(!bookConfig.btnShareWithEmailSubject&&!bookConfig.btnShareWithEmailBody)return"https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&su="+share_title+"&body="+(share_title+"%0D%0A"+encodeURIComponent(share_url));var a=bookConfig.btnShareWithEmailSubject?bookConfig.btnShareWithEmailSubject:share_title,b=bookConfig.btnShareWithEmailBody?
bookConfig.btnShareWithEmailBody:share_description,c=bookConfig.btnShareWithEmailTo||"";b=b.replaceAll("{link}",share_url,!0);b=b.replaceAll("{thumb}",share_screenshot,!0);b=b.replaceAll("{title}",share_title,!0);c&&(c=encodeURIComponent(c));a&&(a=encodeURIComponent(a));b&&(b=encodeURIComponent(b));return"mailto:"+c+"?subject="+a+"&body="+b};
...
("popular"==global.templeteName?this.bigCodeBox.css({"z-index":"2",left:"-200px"}):this.bigCodeBox.css("right","-200px"),this.bigMiniProgramCode.css("right","-195px")):(this.bigCodeBox.css("left","-200px"),this.bigMiniProgramCode.css("left","-195px"));this.shareCode.append(this.bigCodeBox);this.miniProgramCode.append(this.bigMiniProgramCode);this.shareCurrentPageBox=$("<div class='shareCurrentPageBox shareCurrentPageLink'></div>");this.shareCurrentCheck=$("<img alt='' class='shareCurrentPage' src="+
...
b||a.qrcode.find(".miniProgram").addClass("showQR"),e.onTap(function(){this.title1&&this.title1.removeClass("checked");e.addClass("checked");this.qrcode.find(".QRcode").removeClass("showQR");this.qrcode.find(".miniProgram").addClass("showQR")}.bind(a));b&&d&&a.qrcode.addClass("two");a.initCodeCss(b,d);a.showOrHideCheck();g.jumpToEnd()})},initCodeCss:function(a,b){b||(this.codeButton.find(".miniProgram").css({display:"none"}),this.codeButton.find(".qrcode").css({width:"100%",background:"transparent",
opacity:"1",cursor:"auto"}),"popular"!==global.templeteName&&this.shareCode.css({"margin-top":"10px"}));a?this.miniProgramCode.css({display:"none"}):(this.codeButton.find(".qrcode").css({display:"none"}),this.codeButton.find(".miniProgram").css({width:"100%",background:"transparent",opacity:"1",cursor:"auto"}))},fillArea:function(a,b){var c=share_url;0<=c.toLowerCase().indexOf("file:")&&(c="index.html");a&&(this.shareCurrentChecked=a,c=c+"#p="+("function"===typeof getEncodedPageHashValue?getEncodedPageHashValue(BookInfo.getCurrentPageIndex()):
encodeURIComponent(String(getShownPageNumber(BookInfo.getCurrentPageIndex())))));"link"==b&&this.linkArea&&this.linkArea.val(c);this.shareCurrentCheck.attr("src",this.shareCurrentChecked?this.searchOnUrl:this.searchOffUrl);this.shareCurrentCheck[0].colorChanged=!1;this.qrcode.find(".QRcode").empty().qrcode({width:100,height:100,render:"image",text:c});this.shareCode.find(".QRcode").empty().qrcode({width:100,height:100,render:global.isIE8()?"":"image",text:c});this.bigShareCode&&this.bigShareCode.empty().qrcode({width:160,
height:160,render:global.isIE8()?"":"image",text:c})},addItem:function(a){var b=this,c,d,e,g,f,k,h,l,m,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress){if(b.added)return q.return();b.added=!0;b.sharePanel.hide();return q.yield(b.analysisShare.getList(),2)}c=q.yieldResult;if(!c||0>c.length)return q.return();d=c.filter(function(u){return"mobile"===u.filter&&!isPC()||"pc"===u.filter&&isPC()?!1:!0});if(!d.length)return b.sharePanel.show(),null==(e=b.codeBox)||e.css({left:"50%",
transform:"translateX(-50%)"}),a&&a(!0),q.return();b.loading=$("<img alt='' src=\""+uiBaseURL+'loading.gif" style="position: absolute;left: 0;top: 0;right: 0;bottom: 0;margin: auto;"/>');$(b.sharePanel[0].parentElement.parentElement).append(b.loading);g={};for(f=0;f<d.length;g={$jscomp$loop$prop$obj$9:g.$jscomp$loop$prop$obj$9},f++)g.$jscomp$loop$prop$obj$9=d[f],k=void 0,g.$jscomp$loop$prop$obj$9.type&&"copy"==g.$jscomp$loop$prop$obj$9.type?(k=$("<a aria-label='"+g.$jscomp$loop$prop$obj$9.title+"' tabindex='0' class='share-item' id='copy_url' data-clipboard-action='copy' title='"+
g.$jscomp$loop$prop$obj$9.title+"'>\n            <img alt='' src='"+g.$jscomp$loop$prop$obj$9.logo+"'/>\n          </a>"),copyHref(k[0]),BookEvent.trigger("customEvent",["copy_share_link"])):k=-1<g.$jscomp$loop$prop$obj$9.url.indexOf("javascript")?$("<a data-type='"+g.$jscomp$loop$prop$obj$9.type+"' aria-label='"+g.$jscomp$loop$prop$obj$9.title+"' tabindex='0' class='share-item' onclick='"+g.$jscomp$loop$prop$obj$9.url.remove("javascript:")+";return false;' title='"+g.$jscomp$loop$prop$obj$9.title+
"'>\n            <img alt='' src='"+g.$jscomp$loop$prop$obj$9.logo+"'/>\n          </a>"):$("<a data-type='"+g.$jscomp$loop$prop$obj$9.type+"' aria-label='"+g.$jscomp$loop$prop$obj$9.title+"' tabindex='0' class='share-item' target = '_blank' href='"+g.$jscomp$loop$prop$obj$9.url+"' title='"+g.$jscomp$loop$prop$obj$9.title+"'>\n            <img alt='' src='"+g.$jscomp$loop$prop$obj$9.logo+"'/>\n          </a>"),b.sharePanel.append(k),b.itemArray.push(k),h=b,k.bind(_event._end,function(u){return function(){var t=
$(this).attr("title");BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),t,h.shareCurrentChecked]);t=u.$jscomp$loop$prop$obj$9.type;"share_more"==t&&(t="other_method");"twitter"==t&&(t="x");t&&BookEvent.trigger("customEvent",["click_share_with_"+t])}}(g));for(m=l=0;m<b.itemArray.length;m++)n=b.itemArray[m],p=n.find("img")[0],p.onload=function(){l++;l==b.itemArray.length&&(b.loading.remove(),b.sharePanel.show(),a&&a())};q.jumpToEnd()})},initEvent:function(a){this.copy1.bind(_event._click,function(){BookEvent.trigger("share",
[BookInfo.getCurrentPageIndex(),getLanguage("lblCopy","Copy"),self.shareCurrentChecked]);BookEvent.trigger("customEvent",["copy_share_link"]);this.copyFrom(this.linkArea)}.bind(this));this.linkArea.bind(_event._click,function(){this.linkArea.select()}.bind(this));this.shareCurrentCheck.bind(_event._click,function(){this.shareCurrentChecked=!this.shareCurrentChecked;this.afterCheckClick()}.bind(this));this.linkArea.bind("mousedown touchstart pointerdown mouseover mousemove",function(b){b.stopPropagation()});
this.initCodeEvent();this.linkInputChnagedEvent()},afterCheckClick:function(){this.fillArea(this.shareCurrentChecked,"link");this.shareCurrentCheck.attr("src",this.shareCurrentChecked?this.searchOnUrl:this.searchOffUrl);this.shareCurrentCheck[0].colorChanged=!1;this.shareCurrentCheck.changeButtonColor(this.fontColor)},initCodeEvent:function(){bookConfig.SmallProgramUrl&&(this.codeButton.find(".qrcode").bind("click",function(){this.codeButton.find(".qrcode").addClass("active");this.codeButton.find(".miniProgram").removeClass("active");
this.shareCode.show();this.miniProgramCode.hide();BookEvent.trigger("share",[BookInfo.getCurrentPages().join("-"),getLanguage("frmShareQRcode","QRCode"),this.shareCurrentChecked])}.bind(this)),this.codeButton.find(".miniProgram").bind("click",function(){this.codeButton.find(".qrcode").removeClass("active");this.codeButton.find(".miniProgram").addClass("active");this.miniProgramCode.show();this.shareCode.hide();BookEvent.trigger("share",[BookInfo.getCurrentPages().join("-"),getLanguage("frmShareSmallProgram",
"smallProgram"),this.shareCurrentChecked])}.bind(this)),this.miniProgramCode.bind("mouseenter",function(){this.bigMiniProgramCode.fadeIn("100")}.bind(this)),this.miniProgramCode.bind("mouseleave",function(){this.bigMiniProgramCode.fadeOut("100")}.bind(this)));this.shareCode&&(this.shareCode.bind("mouseenter",function(){this.initBigCode();this.bigCodeBox.fadeIn("100")}.bind(this)),this.shareCode.bind("mouseleave",function(){this.bigCodeBox.fadeOut("100")}.bind(this)))},initBigCode:function(){this.bigShareCode||
(this.bigShareCode=$("<div class='bigShareCode'></div>"),this.bigCodeBox.append(this.bigShareCode));var a=share_url;a&&0<=a.toLowerCase().indexOf("file:")&&(a="index.html");this.shareCurrentChecked&&(a=a+"#p="+("function"===typeof getEncodedPageHashValue?getEncodedPageHashValue(BookInfo.getCurrentPageIndex()):encodeURIComponent(String(getShownPageNumber(BookInfo.getCurrentPageIndex())))));this.bigShareCode.empty().qrcode({width:160,height:160,render:global.isIE8()?"":"image",text:a})},linkInputChnagedEvent:function(){if(this.linkArea)this.linkArea.on("input propertychange change",
function(){var a=this,b,c,d,e,g,f,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return b=a.linkArea.val(),0<=b.toLowerCase().indexOf("file:")&&(b="index.html"),share_url=b,a.analysisShare.refreshList(),(c=a.analysisShare.shareList)?h.jumpTo(2):h.yield(a.analysisShare.getList(),3);2!=h.nextAddress&&(c=h.yieldResult);d=c;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$11:e.$jscomp$loop$prop$type$11},g++)f=a.itemArray[g],e.$jscomp$loop$prop$type$11=
f.attr("data-type"),(k=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$11}}(e)))&&(-1<k.url.indexOf("javascript")?f.attr("onclick",k.url.remove("javascript:")+";return false;"):f.attr("href",k.url));h.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=a.val(),copyToClipboard(a)}}},pickElements:function(a){a.itemArray=this.itemArray;a.analysisShare=this.analysisShare;a.shareList=this.shareList;a.shareCode=
...
b.jumpToEnd()})}}).extend(FadeOutFadeForm),PhoneShareForm=Class({create:function(a){this.elements=new ShareElements(this);this.items=[];this._super(a)},onCreate:function(){this.stage.css({color:this.fontColor});this.close.changeButtonColor(this.fontColor);this.back.css({color:this.fontColor});this.favicon&&this.favicon.changeButtonColor(this.fontColor);this._super()},initHtml:function(){var a="Back";"Chinese"==UserGroups&&(a="\u8fd4\u56de");a=getLanguage("btnBack",a);this.back=$("<div class='back'><img alt='' src='"+
(window.zoom_icons&&zoom_icons["arrow-left"]?"data:image/png;base64,"+zoom_icons["arrow-left"]:uiBaseURL+"arrow-left.png")+"'/><span>"+a+"</span></div>");this.stage.append(this.back);this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.qrcode);this.hideQRCode()},initSwiper:function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==
...
"Description")+"</span>");this.logo=$("\n      <a \n        class='aboutLogo' \n        rel='noopener noreferrer' \n        target='_blank' \n        style='display:none;background:url("+bookConfig.CompanyLogoFile+") center center no-repeat;background-size:contain;'\n        href='"+bookConfig.AboutWebsite+"'\n        aria-label='"+getLanguage("ariaProfileLogo","profile logo")+"'\n      ></a>\n    ");this.initDom();this.resetAboutHtml();bookConfig.AboutWebsite&&this.logo.attr("href",bookConfig.AboutWebsite)},
resetAboutHtml:function(){bookConfig.CompanyLogoFile?this.logo.css({display:"inline-block",background:"url('"+bookConfig.CompanyLogoFile+"') center center no-repeat","background-size":"contain",marginBottom:"10px"}):this.logo.css({display:"none"});this.strViews=getLanguage("frmaboutViews",global.aboutReadTimesCaptions);rightToLeft?(this.author.html("<div class='content rtl'>"+bookConfig.AboutAuthor+"</div><span class='title'>:  "+getLanguage("frmaboutAUTHOR","Author")+"</span>"),this.address.html("<div class='content rtl'>"+
bookConfig.AboutAddress+"</div><span class='title'>:  "+getLanguage("frmaboutADDRESS","Address")+"</span>"),this.email.html((bookConfig.AboutEmail?"<a href='mailto:"+bookConfig.AboutEmail+"' target='_blank'><span class='content'>"+bookConfig.AboutEmail+"</span></a>":"<span class='content'></span>")+"<span class='title'>:  "+getLanguage("frmaboutEMAIL","Email")+"</span>"),this.website.html((bookConfig.AboutWebsite?"<a href='"+bookConfig.AboutWebsite+"' target='_blank'><span class='content'>"+bookConfig.AboutWebsite+
"</span></a>":"<span class='content'></span>")+"<span class='title'>:  "+getLanguage("frmaboutWEBSITE","Website")+"</span>"),this.mobile.html((bookConfig.AboutMobile?"<a href='tel:"+bookConfig.AboutMobile+"' target='_blank'><span class='content'>"+bookConfig.AboutMobile+"</span></a>":"<span class='content'></span>")+"<span class='title'>:  "+getLanguage("frmaboutMOBILE","Mobile")+"</span>"),this.description.html("<span class='content rtl'>"+bookConfig.AboutDescription.replaceAll("  ","&ensp;")+"</span></div>"),
this.views.html("<div class='content rtl'>"+this.ReadTimes+"</div><span class='title'>:  "+getLanguage("frmaboutViews",this.strViews)+"</span>")):(this.author.html("<span class='title'>"+getLanguage("frmaboutAUTHOR","Author")+":  </span><span class='content'>"+bookConfig.AboutAuthor+"</span>"),this.address.html("<span class='title'>"+getLanguage("frmaboutADDRESS","Address")+":  </span><span class='content'>"+bookConfig.AboutAddress+"</span>"),this.email.html("<span class='title'>"+getLanguage("frmaboutEMAIL",
"Email")+":  </span>"+(bookConfig.AboutEmail?"<a href='mailto:"+bookConfig.AboutEmail+"' target='_blank'><span class='content'>"+bookConfig.AboutEmail+"</span></a>":"<span class='content'></span>")),this.website.html("<span class='title'>"+getLanguage("frmaboutWEBSITE","Website")+":  </span>"+(bookConfig.AboutWebsite?"<a href='"+bookConfig.AboutWebsite+"' target='_blank'><span class='content'>"+bookConfig.AboutWebsite+"</span></a>":"<span class='content'></span>")),this.mobile.html("<span class='title'>"+
getLanguage("frmaboutMOBILE","Mobile")+":  </span>"+(bookConfig.AboutMobile?"<a href='tel:"+bookConfig.AboutMobile+"' target='_blank'><span class='content'>"+bookConfig.AboutMobile+"</span></a>":"<span class='content'></span>")),this.description.html("<span class='content'>"+bookConfig.AboutDescription.replaceAll("  ","&ensp;")+"</span>"),this.views.html("<span class='title'>"+getLanguage("frmaboutViews",this.strViews)+":  </span><div class='content'>"+this.ReadTimes+"</div>"));this.email.bind(_event._down,
function(){BookEvent.trigger("jumpLink",["about email",BookInfo.getCurrentPages().join("-"),bookConfig.AboutEmail])});this.website.bind(_event._down,function(){BookEvent.trigger("jumpLink",["about website",BookInfo.getCurrentPages().join("-"),bookConfig.AboutWebsite])});this.mobile.bind(_event._down,function(){BookEvent.trigger("jumpLink",["about mobile",BookInfo.getCurrentPages().join("-"),bookConfig.AboutMobile])});this.showOrHideContent()},showOrHideContent:function(){var a="contents";if(isPhone()||
isPad()||"brief"==global.templeteName)a="block";this.views.css({display:this.ReadTimes?a:"none"});this.author.css({display:bookConfig.AboutAuthor?a:"none"});this.address.css({display:bookConfig.AboutAddress?a:"none"});this.email.css({display:bookConfig.AboutEmail?a:"none"});this.website.css({display:bookConfig.AboutWebsite?a:"none"});this.mobile.css({display:bookConfig.AboutMobile?a:"none"});this.description.css({display:bookConfig.AboutDescription?"inline-block":"none"})},initDom:function(){this.views=
$("<div class='views item'></div>");this.author=$("<div class='author item'></div>");this.address=$("<div class='address item'></div>");this.email=$("<div class='email item'></div>");this.website=$("<div class='website item'></div>");this.mobile=$("<div class='mobile item'></div>");this.description=$("<div class='description item'></div>")},pickElements:function(a){a&&(a.contactTitle=this.contactTitle,a.descriptionTitle=this.descriptionTitle,a.logo=this.logo,a.author=this.author,a.address=this.address,
a.email=this.email,a.website=this.website,a.mobile=this.mobile,a.description=this.description,a.views=this.views,a.ReadTimes=this.ReadTimes)},initEvent:function(a){this.contactTitle.onTap(function(){a.showContact()});this.descriptionTitle.onTap(function(){a.showDescription()})},changeLanguage:function(){this.contactTitle.html(getLanguage("frmaboutcaption","Contact"));this.descriptionTitle.html(getLanguage("frmaboutDESCRIPTION","Description"));this.rightToLeft?(this.author.find(".title").html(":"+
